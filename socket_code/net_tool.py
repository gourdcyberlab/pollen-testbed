...
# found this thing on the internet. really wish it came with comments
# works more or less like netcat. buffering is still a little off...
#
#     $ ./net_tool.py -l -p 8080                # on terminal 1
#     $ ./net_tool.py -c -r localhost -p 8080   # on terminal 2
